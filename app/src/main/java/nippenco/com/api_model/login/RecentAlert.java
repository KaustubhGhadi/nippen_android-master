...
public class RecentAlert {
     ...
     * @param deviceId
     */
    public RecentAlert(String deviceName, String alarmName, Integer conditionValue, String description, String conditionName, Integer deviceId, Double feedValue) {
        super();
