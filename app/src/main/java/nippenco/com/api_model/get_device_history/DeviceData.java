...
public class DeviceData {
    ...
    @SerializedName("v_vlnl2l3")
    @Expose
    private List<Double> vVlnl2l3 = null;
     ...
     * @param vVlnl1l2
     */
    public DeviceData(List<Double> ampsI3, List<Double> vVlnl3l1, List<Double> pf1, List<Double> pf2, List<Double> apKwl2, List<Double> vVlnl1l2, List<Double> ampsI2, List<Double> vVlnl2l3, List<Double> frHz, List<Double> apKwl1, List<Double> pf3, List<Double> rh, List<String> timestamps, List<Double> apKwl3, List<Double> ampsI1) {
        super();
        this.ampsI3 = ampsI3;
    ...
    public List<Double> getVVlnl2l3() {
        return vVlnl2l3;
    }

    public void setVVlnl2l3(List<Double> vVlnl2l3) {
        this.vVlnl2l3 = vVlnl2l3;
    }
